...
export const supportInputClass =
  'w-full rounded-xl border border-surface-border/90 bg-surface-elevated/45 px-4 py-2.5 text-sm text-gray-100 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.04)] placeholder:text-gray-600 transition duration-200 ' +
